...
{
  "hasReview": boolean,
  "overallAssessment": "Comprehensive analysis formatted in markdown with proper structure. Be thorough but concise. Focus on actionable items. Use markdown for better presentation.",
  "reviews": [
    {
...
- **Overall Assessment**: Be comprehensive and detailed, focus on actionable items. - analyze the PR holistically using proper markdown formatting.
